  ...
  try
    ...
    if !a:bang && file !~# 'Session\.vim$'
      try
        ...
        " Neovim tags this exception Vim(call):E484: rather than Vim(readfile):E484:,
        " so the original upstream pattern never matches and the error leaks
        " out of VimEnter on the first Obsession call for a new directory.
      endtry
    endif
